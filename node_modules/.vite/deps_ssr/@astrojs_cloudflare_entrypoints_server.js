...
// node_modules/@astrojs/cloudflare/dist/utils/cf.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();
import { sessionKVBindingName } from "virtual:astro-cloudflare:config";

// node_modules/@astrojs/cloudflare/dist/utils/cf-helpers.js
init_define_global_process_env();
init_define_globalThis_process_env();
init_define_process_env();
...
async function handle(request, env, context) {
  if (isPrerender) {
    if (compileImageConfig) {
      const { installAddStaticImage } = await import("./static-image-collection-GU2LUCC2.js");
